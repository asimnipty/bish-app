    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl">Connecting Advisors with Seekers Worldwide</p>
        </div>
      </section>
        ...
        <div className="mb-16">
          <div className="bg-orange-50 rounded-xl p-8 border-l-4 border-orange-500">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              Bisharod is a platform dedicated to connecting knowledgeable advisors with people who seek their expertise. 
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-md p-8 border-2 border-orange-200">
              <h3 className="text-2xl font-bold text-orange-600 mb-4">For Advisors</h3>
            ...
            <div className="bg-white rounded-xl shadow-md p-8 border-2 border-red-200">
              <h3 className="text-2xl font-bold text-red-600 mb-4">For Seekers</h3>
              <p className="text-gray-700 leading-relaxed">
                Our mission is to make quality knowledge accessible to everyone. Whether you're looking to upskill, 
                solve a business problem, get career guidance, or learn something new, Bisharod connects you with 
                experienced professionals who can provide personalized guidance tailored to your needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="space-y-6">
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Advisors Share Expertise</h3>
                <p className="text-gray-700">Advisors create detailed profiles showcasing their skills, experience, and areas of expertise.</p>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Seekers Discover Advisors</h3>
                <p className="text-gray-700">Seekers browse through verified advisors and select those who best match their learning needs.</p>
              </div>
            </div>
            <div className="flex gap-6 items-start">
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="text-gray-700">Advisors conduct sessions and provide guidance tailored to each seeker's specific needs.</p>
              </div>
            </div>
          </div>
        </div>
